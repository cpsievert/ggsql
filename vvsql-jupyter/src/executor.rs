//! Query execution module for vvSQL Jupyter kernel
//!
//! This module handles the execution of vvSQL queries using the existing
//! vvsql library components (parser, DuckDB reader, Vega-Lite writer).

use anyhow::Result;
use polars::frame::DataFrame;
use vvsql::{parser, reader::{DuckDBReader, Reader}, writer::{VegaLiteWriter, Writer}};

/// Result of executing a vvSQL query
#[derive(Debug)]
...
impl QueryExecutor {
    ...
    /// # Arguments
    ///
    /// * `code` - The vvSQL query to execute
    ///
    /// # Returns
    ///
