# vvsql-jupyter Test Suite

Comprehensive testing infrastructure for the vvSQL Jupyter kernel, validating Jupyter messaging protocol compliance and functional correctness.
...
```bash
# From vvsql-jupyter/tests/ directory
